...
void modl_reg(){
  if (!nrn_nobanner_) if (nrnmpi_myid < 1) {
    ...
    fprintf(stderr," \"ch_Cacna1a_cp5.mod\"");
    fprintf(stderr," \"ch_Cacna1a_md229585.mod\"");
    fprintf(stderr," \"ch_Cacna1b_cp6.mod\"");
    fprintf(stderr," \"ch_Cacna1c_cp3.mod\"");
    fprintf(stderr," \"ch_Cacna1d_md121060.mod\"");
    fprintf(stderr," \"ch_Cacna1g_cp41.mod\"");
    fprintf(stderr," \"ch_Cacna1g_md229585.mod\"");
    fprintf(stderr," \"ch_Cacna1i_cp42.mod\"");
    fprintf(stderr," \"ch_Cacna1i_md19920.mod\"");
    fprintf(stderr," \"ch_Hcn1_cp9.mod\"");
    fprintf(stderr," \"ch_Hcn1_md229585.mod\"");
    fprintf(stderr," \"ch_Hcn2_cp10.mod\"");
    fprintf(stderr," \"ch_Hcn3_cp11.mod\"");
    fprintf(stderr," \"ch_Hcn4_cp12.mod\"");
    fprintf(stderr," \"ch_Kcna1_md232813.mod\"");
    fprintf(stderr," \"ch_Kcna1ab1_md80769.mod\"");
    fprintf(stderr," \"ch_Kcnb1_cp23.mod\"");
    fprintf(stderr," \"ch_Kcnb2_cp24.mod\"");
    fprintf(stderr," \"ch_Kcnc1_cp27.mod\"");
    fprintf(stderr," \"ch_Kcnc1_md256632.mod\"");
